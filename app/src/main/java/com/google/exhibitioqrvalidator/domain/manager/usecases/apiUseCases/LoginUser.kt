...
class  markAttendanceUseCases(private val attendanceRepo: APiRepository){
    suspend operator fun invoke(QRcodeId: String): AttendanceResponse {
        return attendanceRepo.markAttendance(QRcodeId)
    }
}